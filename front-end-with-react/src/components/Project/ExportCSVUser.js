...
class ExportCSVUser extends Component {
  constructor(props) {
    super(props);
    this.state = {
      jData: [],
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <h3>General Games Games</h3>
          <p>
            Following form will help to filter games out of all games (approved
            or not) for CSV export
          </p>
        </div>{" "}
        <Form {...formLayout}>
