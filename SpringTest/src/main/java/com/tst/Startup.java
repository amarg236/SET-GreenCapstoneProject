...
public class Startup {
	...
	@Bean //IDK what this does. Wanna say it's for the core bits but don't know anything else. might have something to do with being able to multitask/thread by using multiple beans, not sure.
